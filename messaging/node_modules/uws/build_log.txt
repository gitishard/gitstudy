...
D:\learing program\∫Û∂À¡∑œ∞\node.js\messaging\node_modules\uws>if not defined npm_config_node_gyp (node "C:\Program Files\nodejs\node_modules\npm\bin\node-gyp-bin\\..\..\node_modules\node-gyp\bin\node-gyp.js" rebuild )  else (node "" rebuild ) 
gyp ERR! configure error 
gyp ERR! stack Error: Python executable "C:\Users\lenovo\AppData\Local\Programs\Python\Python36\python.EXE" is v3.6.0b1, which is not supported by gyp.
...
gyp ERR! cwd D:\learing program\ÂêéÁ´ØÁªÉ‰π†\node.js\messaging\node_modules\uws
