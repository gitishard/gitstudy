...
function class_check(obj){
    ...
    return true;
    // for(var i=document.getElementsById("fabuclassform").firstChild;i;i=i.nextSibling){
    //     if(i.tagName&&(i.tagName=="input"||i.tagName=="select"||i.tagName=="textarea")){
    //         if(i.value==""){
    //             i.focus();
    //             return false;
    //         }
    ...
    $("form :input.required").each(function(){
            ...
            $('form :input').blur(function(){
                 ...
                 if( $(this).is('#updatesegment') ){
                    //update=$("#updatesegment").val();
                    //downdate=$("#downdatesegment").val();
                        if( this.value==""){
